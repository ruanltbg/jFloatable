...
(function() {
  ...
  $.Jfloatable = function(el, options) {
    var base, getLimit, getScrollTop, maxTop, originalOffset, reset, setAbsolute, setFix, setInitialPosition, target, targetTop, windowScroll;
    ...
    base.init = function() {
      ...
      return $(window).bind('resize.jFloatable', reset);
    };
    return base.init();
  };
